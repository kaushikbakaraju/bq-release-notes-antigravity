...
def parse_date_to_iso8601(date_str):
    ...
    3. ISO 8601 with offset: '2026-06-15T10:00:00-07:00'
...
def fetch_and_parse_feed(feed_url=None, timeout=DEFAULT_TIMEOUT):
    """
    Fetches the RSS/Atom feed from feed_url (falls back to RELEASE_NOTES_FEED_URL env var or DEFAULT_FEED_URL)
    ...
    # Parse response content using feedparser
